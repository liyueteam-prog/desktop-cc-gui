...
export const en: Messages = {
  common: {
    ...
    copied: "Copied",
    confirmCloseApp:
      "Quit RuYuanAI? All running sessions and terminals will be terminated.",
  },
  chat: {
  ...
  settings: {
    ...
    proxy: "Network Proxy",
    proxyDesc:
      "When enabled, RuYuanAI and the networked child processes it launches will prefer this proxy.",
    ...
    aboutDesc: "RuYuanAI multi-engine AI coding desktop client with built-in RuYuanAI API presets",
    community: "RuYuanAI Community",
    communityDesc:
      "Visit www.dayueai.fun to register or sign in, create an API key, and view model service details.",
    communityQrTip: "Scan with WeChat",
    communityQrAlt: "Official WeChat community QR code",
    socialTitle: "RuYuanAI",
    socialDocs: "Website",
    socialDocsDesc: "Open www.dayueai.fun to get API keys and service details.",
    ruyuanApiTitle: "RuYuanAI API Key",
    ruyuanApiDesc: "Register or sign in at www.dayueai.fun, then create an API key on the Keys page. This client only stores the key you enter.",
    ruyuanApiAction: "Get API Key",
    ...
    openSourceBannerStar: "Visit website",
    openSourceBannerStarAria: "Visit the RuYuanAI website",
    socialGithub: "RuYuanAI website",
    ...
    webAccessDesc: "Let devices on the same network use RuYuanAI in a browser",
    ...
    cliDialogNote:
      "Provider configs are stored in this app only. For RuYuanAI, select the RuYuanAI preset. The API URL is prefilled, so you only need to paste the API key created at www.dayueai.fun.",
    ruyuanSimpleDialogNote:
      "Enter the API URL and API key only. The app generates the client-specific TOML or JSON automatically, so you do not need to edit configuration code.",
    ...
    cliProxySection: "RuYuanAI / Proxy Presets",
    cliProxyHint:
      "Select the RuYuanAI preset to route requests to RuYuanAI-compatible endpoints, or keep using other proxy presets.",
    cliPresetCustom: "Custom",
    cliName: "Name",
    cliNamePlaceholder: "e.g. RuYuanAI",
    cliRemark: "Remark",
    cliRemarkPlaceholder: "Notes about this provider",
    cliBaseUrl: "API URL",
    cliApiKey: "API Key",
    cliShowApiKey: "Show API Key",
    cliHideApiKey: "Hide API Key",
    cliModelPlaceholder: "For example: claude-sonnet-4-6",
    ruyuanSimpleFormHint: "The RuYuanAI API URL is prefilled. Use “Create API Key” to register or sign in at dayueai.fun and create a key.",
    ruyuanCliNav: "RuYuanAI CLI",
    ruyuanCliHeroTitle: "RuYuanAI CLI: one place for global models",
    ruyuanCliHeroDesc: "A branded provider hub for RuYuanAI users. It defaults to the www.dayueai.fun compatible API while keeping manual setup and cc-switch import.",
    ruyuanCliHeroEndpoint: "Default API URL: https://www.dayueai.fun/v1 (Claude Code uses https://www.dayueai.fun).",
    ruyuanCliMethodManualTitle: "1 Manual API setup",
    ruyuanCliMethodManualDesc: "Same as adding a {{name}} channel today: paste API key, API URL, and model name.",
    ruyuanCliMethodCcsTitle: "2 One-click ccswitch import",
    ruyuanCliMethodCcsDesc: "Read local cc-switch Claude / Codex / Grok providers automatically, or import a db/json file.",
    ruyuanCliMethodCatalogTitle: "3 Global model catalog",
    ruyuanCliMethodCatalogDesc: "Show major model vendors in one place so users can pick models via RuYuanAI or compatible channels.",
    ruyuanCliImportAll: "Import all",
    ruyuanCliUseCatalog: "Create key to use",
    ruyuanCliCatalogTitle: "Global models",
    ruyuanCliCatalogDesc: "This list helps users choose models. Actual availability depends on the RuYuanAI account/API key or the compatible channel configured.",
    ruyuanCliCatalogExpand: "Show all",
    ruyuanCliCatalogCollapse: "Collapse",
    ruyuanCliTargetTitle: "Choose target client",
    cliGetRuyuanApiKey: "Create API Key",
    cliRuyuanQuickStartTitle: "Start with RuYuanAI",
    cliRuyuanQuickStartDesc:
      "RuYuanAI users do not need to type the API URL manually. Sign in at www.dayueai.fun, create an API key, then paste it into this desktop client.",
    cliRuyuanQuickStartStep1: "Register or sign in at www.dayueai.fun.",
    cliRuyuanQuickStartStep2: "Open the Tokens / API Keys page and create a new API key.",
    cliRuyuanQuickStartStep3: "Click Add RuYuanAI Channel, paste the API key, save, and switch to it.",
    cliRuyuanSignIn: "Sign in / Register",
    cliRuyuanAddChannel: "Add RuYuanAI Channel",
    cliModel: "Model",
    ...
    cliFetchModelsNeedApiKey: "Enter an API key first",
    cliTestConnection: "Test connection",
    cliTestConnectionLoading: "Testing…",
    cliTestConnectionSuccess: "Connection successful",
    cliTestConnectionSuccessWithModels: "Connected, found {{count}} models",
    cliTestConnectionError: "Connection failed",
    cliSelectFetchedModel: "Models loaded. Choose one from the suggestions or enter one manually.",
    cliOpenModelList: "Open model list",
    cliCloseModelList: "Close model list",
    cliFetchedModelsMenuHint: "{{count}} models loaded. Click one to select it.",
    cliFetchedModelsNoMatch: "No matching model. You can continue entering one manually.",
